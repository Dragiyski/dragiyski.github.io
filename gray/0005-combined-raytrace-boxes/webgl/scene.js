...
export class Scene extends OpenGLScene {
    ...
    onCreate(gl, context) {
        ...
        const box_data = Float32Array.from([
            // Box 1:
            -3.0, 50.0, -5.0, 1.0,
            6.0, 0.0, 0.0, 1.0,
            0.0, 8.0, 0.0, 1.0,
            ...
            -18, 80, 6, 1.0,
            -1, -16, -10, 1.0,
            4.095765225498531, 0.5003349565239683, -1.2101124529882026, 1.0,
            1.64941216794133, -2.8545700556921587, 4.402370872313321, 1.0,
            3, 30, 6, 1.0,
            2.0, 0.0, 0.0, 1.0,
            0.0, -4, 0.0, 1.0,
            0.0, 0.0, 2, 1.0,
        ...
        this.box_texture = gl.createTexture();
        gl.bindTexture(gl.TEXTURE_2D, this.box_texture);
        gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_BASE_LEVEL, 0);
        gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAX_LEVEL, 0);
        gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, gl.NEAREST);
        gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, gl.NEAREST);
        gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA32F, box_data.length / 4, 1, 0, gl.RGBA, gl.FLOAT, box_data);
    ...
    onPaint(gl, context) {
        ...
        gl.bindTexture(gl.TEXTURE_2D, this.box_texture);
        this.raytrace_program.uniform.box_data?.setValue?.(0);
